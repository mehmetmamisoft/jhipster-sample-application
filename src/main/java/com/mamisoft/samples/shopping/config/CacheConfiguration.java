package com.mamisoft.samples.shopping.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mamisoft.samples.shopping.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mamisoft.samples.shopping.repository.UserRepository.USERS_BY_EMAIL_CACHE);
