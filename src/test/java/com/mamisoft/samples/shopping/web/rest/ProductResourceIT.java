...
import com.mamisoft.samples.shopping.domain.Product;
import com.mamisoft.samples.shopping.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().code(DEFAULT_CODE).name(DEFAULT_NAME).price(DEFAULT_PRICE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().code(UPDATED_CODE).name(UPDATED_NAME).price(UPDATED_PRICE);
        return product;
    }
